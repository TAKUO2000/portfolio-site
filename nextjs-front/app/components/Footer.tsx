  ...
  return (
    <footer className="bg-black text-white py-16 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-6">
          <p className="font-bold mb-2">TAKUO2000</p>
          <p className="text-sm text-gray-400">hello@reallygeatsite.com</p>
          <p className="text-sm text-gray-400">+123-456-7890</p>
          <p className="text-sm text-gray-400">www.reallygeatsite.com</p>
        </div>

        <a
          href="#"
          className="text-sm text-gray-400 underline hover:opacity-70 transition-opacity block mb-8"
        >
          Find my resume here
        </a>
        ...
        <div className="flex gap-4">
          ...
          <a href="#" className="hover:opacity-70 transition-opacity">
            <svg
              ...
              viewBox="0 0 24 24"
            >
              <path d="M24 12.073C24 5.405 18.627 0 12 0S0 5.405 0 12.073C0 18.1 4.388 23.094 10.125 24v-8.437H7.078v-3.49h3.047V9.413c0-3.025 1.791-4.697 4.533-4.697 1.312 0 2.686.236 2.686.236v2.97h-1.513c-1.491 0-1.956.931-1.956 1.886v2.265h3.328l-.532 3.49h-2.796V24C19.612 23.094 24 18.1 24 12.073z" />
            </svg>
          </a>
          {/* LinkedIn */}
          <a href="#" className="hover:opacity-70 transition-opacity">
